import styles from '@/styles/pages/reviewscreate.module.css'
...
const AuthReviewsCreationPage = () => {
    return (
        <IsPrivate Component={ReviewsCreationPage} />
    )
}

export default AuthReviewsCreationPage
