        ...
        <div className={styles.postCard}>
            {
                ...
                <>
                    ...
                    <Link href={""} onClick={() => triggerFadeOut(`/posts/edit/${post._id}`)}><AiFillEdit className={styles.editBtn} size={20} color='white' /></Link>
                </>
            }

            <div className={styles.info}>
                <Link href={""} onClick={() => triggerFadeOut(author._id === user._id ? '/profile' : `/users/${author._id}`)}>
                    <p>{title}</p>
