                ...
                <div className={styles.classes}>

                    {
                        classes.length ?
                            ...
                            :
                            <Link onClick={handleNavigation} href={"/classes"}><button className={styles.profileBtn}>Join a class</button></Link>
                    }
                ...
                <div className={styles.carrousel}>
                    {
                        matches.length ?
                            ...
                            :
                            <Link href={"/match"}>Get a Match</Link>
                    }
                </div>
            </div>
                ...
                <div className={styles.carrousel}>
                    {
                        penfriends.length ?
                            ...
                            :
                            <Link href={""} onClick={handleNavigation} to={"/posts"}><button className={styles.profileBtn}>Make Friends</button></Link>
                    }
...
const AuthProfilePage = () => {
    return <IsPrivate Component={ProfilePage} />
}
