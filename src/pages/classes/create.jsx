import styles from '@/styles/pages/classescreate.module.css'
...
const AuthClassesCreatePage = () => {
    return (
        <IsPrivate Component={ClassesCreatePage} />
    )
}

export default AuthClassesCreatePage