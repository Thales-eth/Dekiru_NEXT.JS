                            ...
                            <div key={message._id} className={user._id === sender._id ? styles.messageBlock : styles.otherMessageBlock}>
                                {
                                    msgContent.startsWith("https://res.cloudinary.com/")
                                        ...
                                        <div className={styles.imageBlock}>
                                            <Image width={200} height={250} className={styles.picMsg} src={msgContent} alt="imageMsg" />
                                            <div className={styles.donwload}>
                                                <Link target='_blank' href={msgContent} download onClick={(e) => e.stopPropagation()}>
                                ...
                                <div className={styles.avatarBlock}>
                                    <Link href={`/users/${sender._id}`}><Image width={200} height={250} className={styles.avatar} src={sender.avatar} alt="avatar" /></Link>
