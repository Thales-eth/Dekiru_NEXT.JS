    ...
    return (
        <div className={styles.hero}>
            ...
            <div className={styles.mainButtons}>
                <Link href={""} onClick={(e) => triggerNavigation("/posts", e)} className={styles.japanButton}>Find Friends</Link>
                <Link href={""} onClick={(e) => triggerNavigation("/classes", e)} className={styles.blackButton}>Classes</Link>
            </div>
        </div>
    )
}
