        ...
        <div className={styles.finder}>
            ...
            <div className={styles.filters}>
                <div className={styles.flags}>
                    <Image width={"100px"} height={"100px"} className={`${styles.flag} ${activeLanguage === "Spanish" ? styles.active : ""}`} onClick={() => triggerLanguageFilter("Spanish")} src={SpainFlag} alt="spanish" />
                    <Image width={"100px"} height={"100px"} className={`${styles.flag} ${activeLanguage === "Japanese" ? styles.active : ""}`} onClick={() => triggerLanguageFilter("Japanese")} src={JapanFlag} alt="japanese" />
