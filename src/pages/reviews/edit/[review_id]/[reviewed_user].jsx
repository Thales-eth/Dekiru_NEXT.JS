import styles from '@/styles/pages/reviewsedit.module.css'
...
const ReviewsEditPage = () => {
    ...
    const { review_id, reviewed_user } = router.query
...
const AuthReviewsEditPage = () => {
    return (
        <IsPrivate Component={ReviewsEditPage} />
    )
}

export default AuthReviewsEditPage