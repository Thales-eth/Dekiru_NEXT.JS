...
const ConversationsListPage = () => {
    ...
    useEffect(() => {
        if (!socket) {
            const newSocket = io.connect(`${process.env.NEXT_PUBLIC_SOCKET_URL}`, { transports: ['websocket'] });
            setSocket(newSocket)
        }
...
const AuthConversationsListPage = () => {
    return (
        <IsPrivate Component={ConversationsListPage} />
    )
}

export default AuthConversationsListPage